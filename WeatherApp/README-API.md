...
2. **Google Maps Geocoding API** - For reverse geocoding (coordinates to city names)
...
#### Endpoint Used
- **Reverse Geocoding**: `GET https://maps.googleapis.com/maps/api/geocode/json`
...
- **Google Maps Geocoding**: [Google Cloud Console](https://console.cloud.google.com/) (free tier: $200 credit)
